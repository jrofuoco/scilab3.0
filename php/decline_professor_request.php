<?php
/**
 * decline_professor_request.php
 * Declines a student reservation request (professor rejection)
 */
...
try {
    ...
    if ($stmt->rowCount() > 0) {
        ...
        error_log("Professor ID $professorId declined reservation ID $reservationId");
    ...
    $pdo->rollBack();
    error_log("Database error in decline_professor_request: " . $e->getMessage());
    echo json_encode([
        'success' => false,
